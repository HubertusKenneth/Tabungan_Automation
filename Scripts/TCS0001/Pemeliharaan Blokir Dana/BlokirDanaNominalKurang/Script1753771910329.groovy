...
WebUI.click(findTestObject('Object Repository/BlokirRekYangDipakaiTes/Page_ARB Banking System/input_Kode Blokir_xui.UI.ComboInput-INPUTm (1)'))

WebUI.click(findTestObject('Object Repository/BlokirRekYangDipakaiTes/Page_ARB Banking System/span_02 - JAMINAN'))
...
WebUI.setText(findTestObject('Object Repository/BlokirRekYangDipakaiTes/Page_ARB Banking System/input_Jumlah_xui.UI.ComboInput-INPUTn'), 
    '1')

WebUI.sendKeys(findTestObject('Object Repository/BlokirRekYangDipakaiTes/Page_ARB Banking System/input_Jumlah_xui.UI.ComboInput-INPUTn'), 
    Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Object Repository/BlokirRekYangDipakaiTes/Page_ARB Banking System/input_Tanggal Berakhir_xui.UI.ComboInput-INPUTo'))

WebUI.click(findTestObject('Object Repository/BlokirRekYangDipakaiTes/Page_ARB Banking System/td_9'))

WebUI.setText(findTestObject('Object Repository/BlokirRekYangDipakaiTes/Page_ARB Banking System/input_Alasan_xui.UI.Input-INPUTm'), 
    'test')
...
WebUI.click(findTestObject('Object Repository/BlokirRekYangDipakaiTes/Page_ARB Banking System/span_O K (1)'))
