...
WebUI.doubleClick(new TestObject().addProperty('xpath', ConditionType.CONTAINS, "//input[contains(@id,'ComboInput-INPUT:p:')]"))

WebUI.click(new TestObject().addProperty('xpath', ConditionType.EQUALS, "//td[contains(text(),'AD5')]"))

WebUI.doubleClick(new TestObject().addProperty('xpath', ConditionType.CONTAINS, "//input[contains(@id,'ComboInput-INPUT:q:')]"))

WebUI.click(findTestObject('Object Repository/MelihatDataLaporanBlokirDana/Page_ARB Banking System/td_TABUNGAN BERJANGKA KENDARAAN'))
