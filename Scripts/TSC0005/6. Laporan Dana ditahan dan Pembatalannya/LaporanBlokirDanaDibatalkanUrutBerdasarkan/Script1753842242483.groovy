...
WebUI.click(findTestObject('Object Repository/MelihatDataLaporanBlokirDana/Page_ARB Banking System/input_Berdasarkan_xui.UI.ComboInput-INPUTu'))

WebUI.click(new TestObject().addProperty('xpath', ConditionType.CONTAINS, "//span[contains(@id,'List-CAPTION') and text()='DANA DITAHAN']"))
